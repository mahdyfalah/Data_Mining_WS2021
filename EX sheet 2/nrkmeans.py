...
class NrKmeans():
    def __init__(self, n_clusters, V=None, m=None, P=None, centers=None, max_iter=300, allow_larger_noise_space=True,
        ...
        """
        # Fixed attributes
        self.input_n_clusters = n_clusters
    ...
    def fit(self, X, best_of_n_rounds=10):
        """
        ...
        for i, seed in enumerate(self.random_state.randint(0, 10000, best_of_n_rounds)):
            ...
            print(
                f"found solution with: {this_costs} (current best is {current_best_costs})")
    ...
    if centers is None:
        ...
        for i in range(subspaces):
            ...
            if k > 1:
                ...
                centers_cropped,_ = kpp(cropped_X, k, row_norms(
